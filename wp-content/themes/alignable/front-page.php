...
<main class="splash-content">
	<section class="about-ac">
		<div class="inner">
			<h1>About Alignable Capital</h1>
			<p>Gummi bears dessert soufflé. Cupcake fruitcake marshmallow cake cupcake tiramisu sesame snaps. Powder cotton candy lollipop gummi bears apple pie danish cookie. Lemon drops cheesecake cheesecake chocolate bar carrot cake oat cake pastry.</p>
		</div>
	</section>
			...
			<section class="cta">
				<ul>
					...
					<li>
						...
						<h2>Apply Online</h2>
						<p>Powder cotton candy lollipop gummi bears apple pie danish cookie.</p>
					</li>
					<li>
						...
						<h2>Get Approved</h2>
						<p>Lemon drops cheesecake cheesecake chocolate bar carrot cake oat cake pastry.</p>
					</li>
					<li>
						...
						<h2>Get Your Cash</h2>
						<p>Gummi bears dessert soufflé.</p>
					</li>
				</ul>
			</section>
